...
//   return (
    // <div className="bg-white p-6 cursor-pointer border rounded-lg shadow-x w-6/4 flex flex-col justify-between hover:drop-shadow-lg">
//       <div>
...
//     title === 'New Accounts' || title === 'Pending Loans' || title === 'Loan Request'
//       ? 'bg-red-300' 
//       : title === 'Total Funds' || title === 'Pending Loans' // Error was here
//       ? 'bg-green-100' 
