...
import Logo from '../assets/Logo.svg'
  ...
  return (
    <>
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:w-[279px] lg:flex-col border-r-4 bg-gray-50 px-4 pb-4">
        <div className="flex h-16 items-center">
          <img alt="Your Company" src={Logo} className="h-12 w-auto my-5" />
        </div>
        <nav className="flex flex-1 flex-col">
          <ul className="flex flex-1 flex-col gap-y-7">
            {navigation.map((item) => (
